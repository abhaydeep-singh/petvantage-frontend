        ...
        <div className="flex flex-wrap justify-center gap-6 pb-12">
          {petCategories.map((pet, index) => (
            <div key={index} className="relative group">
              <Card
                className="w-40 md:w-48 lg:w-56 rounded-xl shadow-lg transition-transform transform group-hover:scale-105 group-hover:-translate-y-1 overflow-hidden border border-gray-700 
  group-hover:shadow-xl group-hover:shadow-yellow-500/50"
              >
